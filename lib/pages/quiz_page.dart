...
import 'package:quiz_refactor/models/question.dart';
...
class _QuizPageState extends State<QuizPage> {
  ...
  Color getAnswerColor(int _selected, int _currentQuestion, List questions,
      int index, bool border) {
    if (_selected == index &&
        questions[_currentQuestion].answers[_selected] ==
            questions[_currentQuestion].correctAnswer) {
      return Color(0xff42b4a5);
    } else if (_selected == index &&
        questions[_currentQuestion].answers[_selected] !=
            questions[_currentQuestion].correctAnswer) {
      return Color(0xffca4b4b);
    } else if (_selected != index &&
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        toolbarHeight: 70,
        backgroundColor: Color(0xff42b4a5),
        leading: IconButton(
          onPressed: () {
            showDialog(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(color: Color(0xffffe185)),
                      child: Column(
